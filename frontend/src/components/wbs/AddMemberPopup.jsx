            ...
            <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md min-h-[420px] flex flex-col justify-between border border-blue-100">
                <div>
                    <div className="flex justify-between items-center mb-4">
                        <h2 className="text-2xl font-extrabold text-blue-800 tracking-tight">Add Member</h2>
                        <button
                            onClick={onClose}
                    ...
                    <div className="mb-6 mt-10">
                        <label htmlFor="member" className="block text-sm font-semibold text-blue-700 mb-2">Select Member</label>
